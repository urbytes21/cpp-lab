...
// *0. Define some enums
// Unscope enum
enum BasicEnum { enumratorA, enumratorB, enumratorC };

// Scoped enum - enumrators are inside enum's scope
enum class ScopeEnumClass { enumratorA, enumratorB, enumratorC };
...
void enums() {
  ...
  [[maybe_unused]] EnumNameSpace::ScopeEnumClass scope_e_c_n =
      EnumNameSpace::ScopeEnumClass::enumratorA;
